          ...
          <div className="mx-auto max-w-7xl text-center flex-1 flex flex-col justify-center">
            ...
            >
              ...
              >
                <Badge
                  variant="secondary"
                  className="inline-flex items-center gap-4 px-8 py-4 text-base bg-gradient-to-r from-slate-800/80 to-slate-700/80 border border-slate-600/50 backdrop-blur-sm shadow-2xl rounded-2xl"
                >
                  <motion.div
                    animate={{ rotate: 360 }}
                    transition={{
            ...
            >
              ...
              <p className="text-xl sm:text-2xl text-slate-400 leading-relaxed max-w-4xl mx-auto">
                Advanced analytics, intelligent insights, and seamless
                blockchain integration to revolutionize how you manage your
              ...
              >
                <div className="text-center p-8 bg-gradient-to-b from-slate-800/50 to-slate-900/50 rounded-3xl border border-slate-700/50 backdrop-blur-sm hover:scale-105 transition-transform duration-300">
                  ...
                  <p className="text-slate-400 leading-relaxed">
                    AI-powered insights for your financial data with predictive
                    modeling
                  </p>
                </div>
                ...
                <div className="text-center p-8 bg-gradient-to-b from-slate-800/50 to-slate-900/50 rounded-3xl border border-slate-700/50 backdrop-blur-sm hover:scale-105 transition-transform duration-300">
                  ...
                  <p className="text-slate-400 leading-relaxed">
                    Enterprise-grade security with Web3 integration and smart
                    contracts
                  </p>
                </div>
                ...
                <div className="text-center p-8 bg-gradient-to-b from-slate-800/50 to-slate-900/50 rounded-3xl border border-slate-700/50 backdrop-blur-sm hover:scale-105 transition-transform duration-300">
                  ...
                  <p className="text-slate-400 leading-relaxed">
                    Instant financial calculations and reporting with live
                    market data
                  </p>
                </div>
              </motion.div>
