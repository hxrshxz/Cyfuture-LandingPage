      ...
      <div className="mx-auto max-w-7xl">
        <div className="mx-auto max-w-[540px]">
          <div className="flex justify-center">
            ...
            >
              <div className="absolute inset-x-0 -top-px mx-auto h-0.5 w-1/2 bg-gradient-to-r from-transparent via-[color:var(--brand-blue)] to-transparent shadow-2xl transition-all duration-500 group-hover:w-3/4"></div>
              <div className="absolute inset-x-0 -bottom-px mx-auto h-0.5 w-1/2 bg-gradient-to-r from-transparent via-[color:var(--brand-blue)] to-transparent shadow-2xl transition-all duration-500 group-hover:h-px"></div>
          ...
          <p className="mt-5 relative z-10 text-center text-lg text-zinc-500">
            From cryptographic accuracy to instant fraud detection, VerifiChain
            is the future of financial compliance.
          </p>
        </div>
        ...
        <div className="-mt-8 flex justify-center">
          <button className="group relative inline-flex items-center gap-2 rounded-full border border-[color:var(--brand-blue)]/30 bg-black/50 px-6 py-3 text-sm font-medium text-white transition-all hover:border-[color:var(--brand-blue)]/60 hover:bg-[color:var(--brand-blue)]/10 active:scale-95">
            <div className="absolute inset-x-0 -top-px mx-auto h-px w-3/4 bg-gradient-to-r from-transparent via-[color:var(--brand-blue)]/40 to-transparent"></div>
            <div className="absolute inset-x-0 -bottom-px mx-auto h-px w-3/4 bg-gradient-to-r from-transparent via-[color:var(--brand-blue)]/40 to-transparent"></div>
            <svg
              className="h-4 w-4 text-[color:var(--brand-blue)]"
              fill="currentColor"
              viewBox="0 0 24 24"
            >
