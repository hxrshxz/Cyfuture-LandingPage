...
import { PieChart, TrendingUp, TrendingDown, ArrowUp, ArrowDown, Plus } from "lucide-react"
        ...
        <div className="p-6 space-y-6">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-slate-400 mt-2">Track your investments and crypto holdings</p>
            </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <Card className="bg-slate-800/50 border-slate-700">
              <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
                ...
                <Badge variant="secondary" className="bg-purple-500/20 text-purple-300">3 Assets</Badge>
              </CardHeader>
              <CardContent>
                  ...
                  <div key={index} className="flex items-center justify-between p-4 bg-slate-900/50 rounded-lg border border-slate-700">
                    <div className="flex items-center space-x-4">
                      ...
                      <div>
                        ...
                        <p className="text-slate-400 text-sm">{holding.amount} {holding.symbol.replace('USDT', '')}</p>
                      </div>
                    </div>
                    <div className="text-right">
                      <div className="font-semibold text-white">{holding.value}</div>
          ...
          <Card className="bg-gradient-to-r from-purple-500/10 to-pink-500/10 border-purple-500/30">
            <CardHeader>
              <CardTitle className="text-white flex items-center gap-2">
                <Badge variant="secondary" className="bg-purple-500/20 text-purple-300">AI</Badge>
                Investment Recommendations
              </CardTitle>
            </CardHeader>
            <CardContent className="space-y-4">
              <div className="p-4 bg-slate-800/50 rounded-lg">
                <h4 className="font-semibold text-white mb-2">Diversification Opportunity</h4>
                <p className="text-slate-300">Consider adding some traditional assets or stablecoins to balance your crypto-heavy portfolio.</p>
              </div>
              <div className="p-4 bg-slate-800/50 rounded-lg">
                <h4 className="font-semibold text-white mb-2">Rebalancing Suggestion</h4>
                <p className="text-slate-300">Your Bitcoin allocation is at 57%. Consider taking some profits and diversifying into other assets.</p>
              </div>
            </CardContent>
          </Card>
        </div>
