...
import { PieChart, TrendingUp, DollarSign, ArrowUp, ArrowDown } from "lucide-react"
        ...
        <div className="p-6 space-y-6">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-slate-400 mt-2">Deep insights into your financial performance</p>
            </div>
          ...
          <Card className="bg-gradient-to-r from-cyan-500/10 to-purple-500/10 border-cyan-500/30">
            <CardHeader>
              <CardTitle className="text-white flex items-center gap-2">
                <Badge variant="secondary" className="bg-cyan-500/20 text-cyan-300">AI</Badge>
                Financial Insights
              </CardTitle>
            </CardHeader>
            <CardContent className="space-y-4">
              <div className="p-4 bg-slate-800/50 rounded-lg">
                ...
                <p className="text-slate-300">Your Q4 revenue shows strong growth. Consider increasing marketing spend in the next quarter to capitalize on this trend.</p>
              </div>
              <div className="p-4 bg-slate-800/50 rounded-lg">
                <h4 className="font-semibold text-white mb-2">Cost Management</h4>
                <p className="text-slate-300">Office expenses have increased by 15%. Review recurring subscriptions and negotiate better rates with vendors.</p>
              </div>
